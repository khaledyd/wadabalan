    ...
    <Mininav/>
      ...
      >
        ...
        <Box component="form" sx={{}} noValidate autoComplete="off">
          ...
          <Button mt={3} sx={{ marginTop: "20px", backgroundColor:"#F675A8" ,color:"#fff" , padding:"5px 30px"}}>Sign Up</Button>
          <Typography variant="h6" sx={{fontSize:"15px" , marginTop:"10px"}}>log in</Typography>
